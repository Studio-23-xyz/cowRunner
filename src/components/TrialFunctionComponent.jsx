...
import videoMusic from './Game/gameAssets/Music-JTI.mp4'
...
//     ]
    ...
    console.log(this.tutorialStep)
      ...
      document.getElementById("tutorialText").innerHTML=tutorialText[this.tutorialStep]
      if(this.tutorialStep===4){
        document.getElementById('fakeRoadBreaker').style.display="block"
         document.getElementById('fakeGamebr').style.animation="animation-breaker .3s infinite alternate"
      ...
      if (this.RoadImgPos>3450) {
        ...
        this.gameTutorialShowPos=this.state.RoadImgPos-(this.tutorialStep>=3?window.innerWidth-250:300)
      }
  ...
  camelImageChange = () => {
    ...
    if (!this.state.coundown && !this.state.crashedGame&& this.tutorialStep!==5) {
      this.camelanimation++
    }
  }
  RestartGame = () => {
  ...
  fakeRoadBreakerAnimation=()=>{
     this.state.fakeRoadBr+=this.state.roadSpeed
          document.getElementById('fakeRoadBreaker').style.right=this.state.fakeRoadBr+'px'
          
  }
  
  tutorialMode= (RoadImg) => {
    
    if (this.state.RoadImgPos > -4000 && (this.tutorialStep<5||this.tutorialStep>5)) {
    ...
    if(this.state.RoadImgPos>=this.gameTutorialShowPos &&this.state.RoadImgPos <=(this.gameTutorialShowPos+15)&& !this.isShowGameTutorial){
  ...
  realGameMode = (RoadImg,getCamelImg,getRoadBrImg) => {
    ...
    if (
      ((this.state.RoadImgPos <= -firstBreaker && this.state.RoadImgPos >= -firstBreakerEnd) ||
        ...
        (this.state.RoadImgPos <= -(4170) &&
          this.state.RoadImgPos >= -(4170+135) && this.state.fakeRoadBrPause==="top")) &&
      getCamelImg.style.bottom === '80px'
    ) {
    ...
    if (
      ((this.state.RoadImgPos <= -(firstBreaker+655) &&
        ...
        (this.state.RoadImgPos <= -(4155) &&
          this.state.RoadImgPos >= -4155-180 && this.state.fakeRoadBrPause==="bottom")) &&
      getCamelImg.style.bottom === '32px'
    ) {
      // getRoadBrImg.style.zIndex = 3
      // getCamelImg.style.zIndex = 2
    ...
    if (this.state.fakeRoadBr<window.innerWidth+900 && !this.state.crashedGame) {
      this.fakeRoadBreakerAnimation()
    }
  }
  ...
  gameanimation = () => {
    ...
    let getCamelImg = document.getElementById('Gamecamel')
    let getRoadBrImg = document.getElementById('Gamebr')
    this.tutorialStep>5 ? this.realGameMode(RoadImg,getCamelImg,getRoadBrImg) : this.tutorialMode(RoadImg,getCamelImg,getRoadBrImg)
      ...
      <>
        ...
        >
          ...
          <div id="gameInstruction_game">
            ...
            >
              <img width="66" height="66" src="https://img.icons8.com/external-smashingstocks-glyph-smashing-stocks/66/external-next-button-maps-and-navigations-smashingstocks-glyph-smashing-stocks.png" alt="external-next-button-maps-and-navigations-smashingstocks-glyph-smashing-stocks"/>
            </div>
          </div>
